package com.savor.ads.okhttp.coreProgress;

import com.savor.ads.okhttp.coreProgress.download.ProgressResponseBody;
import com.savor.ads.okhttp.coreProgress.download.ProgressResponseListener;
import com.savor.ads.okhttp.coreProgress.upload.ProgressRequestBody;
import com.savor.ads.okhttp.coreProgress.upload.ProgressRequestListener;
...
public class ProgressHelper {
     ...
     */
    public static OkHttpClient addProgressResponseListener(OkHttpClient client, final ProgressResponseListener progressListener,final String fileName) {
        //克隆
