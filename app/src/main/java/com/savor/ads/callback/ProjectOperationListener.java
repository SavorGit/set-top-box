...
//        dbHelper.close();
    ...
    @Override
    public PrepareResponseVoNew showImage(int imageType, String imgagePath,boolean isThumbnail,String forscreenId,String delayTime,int action,int fromService) {
        PrepareResponseVoNew localResult = new PrepareResponseVoNew();
        if (isThumbnail) {
            if (!TextUtils.isEmpty(GlobalValues.CURRENT_PROJECT_ID)) {
                GlobalValues.LAST_PROJECT_ID = GlobalValues.CURRENT_PROJECT_ID;
        ...
        ImageAction imageAction = new ImageAction(mContext, imageType,imgagePath, isThumbnail,forscreenId,delayTime,action,fromService);
    ...
    @Override
    public PrepareResponseVoNew showRestVideo(String videoPath, boolean isNewDevice,String avatarUrl,String nickname,int projectionTime,int action,int fromService) {
        PrepareResponseVoNew localResult = new PrepareResponseVoNew();
        if (!TextUtils.isEmpty(GlobalValues.CURRENT_PROJECT_ID)) {
            GlobalValues.LAST_PROJECT_ID = GlobalValues.CURRENT_PROJECT_ID;
        }
        ...
        VideoRestAction videoAction = new VideoRestAction(mContext, videoPath, isNewDevice,avatarUrl,nickname,projectionTime,action,fromService);
    ...
    @Override
    public PrepareResponseVoNew showRestVideo(String videoPath,String videoUrl, boolean isNewDevice,String avatarUrl,String nickname,int projectionTime,int action,int fromService) {
        PrepareResponseVoNew localResult = new PrepareResponseVoNew();
        if (!TextUtils.isEmpty(GlobalValues.CURRENT_PROJECT_ID)) {
            GlobalValues.LAST_PROJECT_ID = GlobalValues.CURRENT_PROJECT_ID;
        }
        ...
        VideoRestAction videoAction = new VideoRestAction(mContext, videoPath,videoUrl, isNewDevice,avatarUrl,nickname,projectionTime,action,fromService);
        ProjectionManager.getInstance().enqueueAction(videoAction);
    ...
    @Override
    public PrepareResponseVoNew showRestVideo(String videoPath,boolean isNewDevice,String price,String imgPath,int action,int fromService) {
        PrepareResponseVoNew localResult = new PrepareResponseVoNew();
        if (!TextUtils.isEmpty(GlobalValues.CURRENT_PROJECT_ID)) {
            GlobalValues.LAST_PROJECT_ID = GlobalValues.CURRENT_PROJECT_ID;
        }
        ...
        VideoRestAction videoAction = new VideoRestAction(mContext, videoPath,isNewDevice,price,imgPath,action,fromService);
        ProjectionManager.getInstance().enqueueAction(videoAction);
    ...
    @Override
    public PrepareResponseVoNew showVideo(String videoPath, String videoUrl,boolean isNewDevice,String forscreenId,String avatarUrl,String nickname,int action,int fromService) {
        PrepareResponseVoNew localResult = new PrepareResponseVoNew();
        if (!TextUtils.isEmpty(GlobalValues.CURRENT_PROJECT_ID)) {
            GlobalValues.LAST_PROJECT_ID = GlobalValues.CURRENT_PROJECT_ID;
        }
        ...
        VideoAction videoAction = new VideoAction(mContext, videoPath,videoUrl,isNewDevice,forscreenId,avatarUrl,nickname,action,fromService);
        ProjectionManager.getInstance().enqueueAction(videoAction);
    ...
    @Override
    public PrepareResponseVoNew showVideo(String videoPath, boolean isNewDevice,String forscreenId,String avatarUrl,String nickname,int action,int fromService) {
        PrepareResponseVoNew localResult = new PrepareResponseVoNew();
        if (!TextUtils.isEmpty(GlobalValues.CURRENT_PROJECT_ID)) {
            GlobalValues.LAST_PROJECT_ID = GlobalValues.CURRENT_PROJECT_ID;
        }
        ...
        VideoAction videoAction = new VideoAction(mContext, videoPath, isNewDevice,forscreenId,avatarUrl,nickname,action,fromService);
        ProjectionManager.getInstance().enqueueAction(videoAction);
    ...
    @Override
    public void showMiniProgramCode(String filename,int action,int from_service) {
        Activity activity = ActivitiesManager.getInstance().getCurrentActivity();
        if (activity instanceof AdsPlayerActivity||activity instanceof ScreenProjectionActivity) {
            ...
            if (file.exists()) {
                VodAction vodAction = new VodAction(mContext, ConstantValues.QRCODE_CALL_VIDEO_ID, path, false, true,action,from_service);
                ProjectionManager.getInstance().enqueueAction(vodAction);
            }
        }
    }
